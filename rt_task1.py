...
list is a collection data type that is ordered and mutable, meaning that the elements can be changed after the list is created.
"""
...
print("List after appending 'grape':", my_list)
...
# Sorting a separate numeric list
num_list = [5, 3, 1, 4, 2]
num_list.sort()
...
A dictionary is a collection of key-value pairs. It is unordered, mutable, and indexed by keys, which are unique and must be immutable types.
"""
...
# Discarding an element that may not be in the set
my_set.discard('pear')
